...
class QTLConfig:
    ...
    def __init__(self,  snp_file_location=None, probe_file_location=None, output_location=None, covariates_file_location=None, covariates_to_use=None, snp_positions_file_location = None, probe_positions_file_location=None, use_model='linear', confinements_snp_location=None, confinements_probe_location=None, confinements_snp_probe_pairs_location=None, cis_dist=10000, maf=0.01, cis=True):
        """
        constructor
